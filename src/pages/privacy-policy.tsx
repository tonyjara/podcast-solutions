  ...
  return (
    <Box display={"flex"} justifyContent={"center"}>
      <Box maxW={"800px"} width={"100%"}>
        <Heading>
          <strong>PODCAST SOLUTIONS Privacy policy</strong>
        </Heading>
        <br />
        ...
        <p>
          Welcome to Podcast Solutions ("we", "us", or "our"). We are committed
          ...
          <a href="https://podcastsolutions.org">
        ...
        <ul>
          <li>
            ...
            contact email{" "}
            <a href="mailto:pcastsolutions@gmail.com">
              pcastsolutions@gmail.com
            </a>
            .
          </li>
          <br />
        ...
        <p>
          ...
          <a href="mailto:pcastsolutions@gmail.com">pcastsolutions@gmail.com</a>
          .
        </p>
