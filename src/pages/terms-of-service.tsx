    ...
    return (
        <Box display={"flex"} justifyContent={"center"}>
            <Box maxW={"800px"} width={"100%"}>
                ...
                <br />
                <Heading size={"md"}>Welcome to Podcast Solutions!</Heading>
                <br />

                <p>
                    These terms and conditions outline the rules and regulations for the
                    use of Podscast Solutions's Website, located at
                ...
                <p>
                    ...
                    conditions. Do not continue to use Podcast Solutions if you do not
                ...
                <br />
                <p>
                    We employ the use of cookies. By accessing Podcast Solutions, you
                    agreed to use cookies in agreement with the Podscast Solutions's
                    Privacy Policy.{" "}
                </p>
                ...
                <br />
                <p>
                    Unless otherwise stated, Podscast Solutions and/or its licensors own
                    the intellectual property rights for all material on Podcast
                    Solutions. All intellectual property rights are reserved. You may
                    access this from Podcast Solutions for your own personal use subjected
                ...
                <br />
                <ul>
                    <li>Republish material from Podcast Solutions</li>
                    <li>Sell, rent or sub-license material from Podcast Solutions</li>
                    <li>Reproduce, duplicate or copy material from Podcast Solutions</li>
                    <li>Redistribute content from Podcast Solutions</li>
                </ul>
                <br />
                ...
                <p>
                    ...
                    Podscast Solutions does not filter, edit, publish or review Comments
                    prior to their presence on the website. Comments do not reflect the
                    views and opinions of Podscast Solutions,its agents and/or affiliates.
                    ...
                    Podscast Solutions shall not be liable for the Comments or for any
                ...
                <br />
                <p>
                    Podscast Solutions reserves the right to monitor all Comments and to
                ...
                <br />
                <p>
                    You hereby grant Podscast Solutions a non-exclusive license to use,
                ...
                <p>
                    ...
                    the hyperlink compensates the absence of Podscast Solutions; and (d)
                ...
                <p>
                    ...
                    sending an e-mail to Podscast Solutions. Please include your name,
                ...
                <p>
                    No use of Podscast Solutions's logo or other artwork will be allowed
