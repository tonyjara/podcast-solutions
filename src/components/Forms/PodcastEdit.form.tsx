            ...
            <Flex flexDir={"column"} gap={5} py={"10px"}>
                ...
                {!podcast.active && !prefs?.hasSeenOnboarding && (
                    <Text color={"orange.300"}>
                        If you do not wish to publish your podcast through our
                        platform and you just want to use our services you can
                        skip this step.
                    </Text>
                )}
                ...
                <Text color={"gray.500"} mt={"-20px"}>
                    The date when your podcast was first published. If you
                    select a future date the publication will be scheduled.
                </Text>
