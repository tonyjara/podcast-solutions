...
const DynamicTable = <T extends object>({
    ...
    const rowHoverColor = useColorModeValue("brand.400", "gray.700")
    const thBg = useColorModeValue("white", "gray.700")
